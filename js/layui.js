...
layui.define("jquery", function(t) {
    ...
    var u = layui.$,
        ...
        y = (i.prototype.set = function(t) {
            ...
            return n[0] ? n.before(s) : l.append(s), e.append('<div class="layui-tab-item" ' + (i.id ? 'lay-id="' + i.id + '"' : "") + ">" + (i.content || "") + "</div>"), i.change && this.tabChange(t, i.id), l.data("LAY_TAB_CHANGE", i.change), C.tabAuto(i.change ? "change" : null), this
        ...
        C = {
            tabClick: function(t) {
                ...
                l || n || (a.addClass(r).siblings().removeClass(r), (o ? l = (l = i.filter('[lay-id="' + o + '"]')).length ? l : i.eq(t) : i.eq(t)).addClass(h).siblings().removeClass(h)), layui.event.call(this, c, "tab(" + s + ")", {
                    elem: e,
                    index: t,
                    id: o
                })
            ...
            tabDelete: function(t, i) {
                var i = i || u(this).parent(),
                    ...
                    n = e.attr("lay-filter"),
                    s = i.attr("lay-id");
                !1 !== layui.event.call(i[0], c, "tabBeforeDelete(" + n + ")", {
                    elem: e,
                    index: a,
                    id: s
                }) && (i.hasClass(r) && (i.next()[0] && i.next().is("li") ? C.tabClick.call(i.next()[0], {
                    index: a + 1
                }) : i.prev()[0] && i.prev().is("li") && C.tabClick.call(i.prev()[0], null, a - 1)), i.remove(), (s ? i = (i = l.filter('[lay-id="' + s + '"]')).length ? i : l.eq(a) : l.eq(a)).remove(), setTimeout(function() {
                    C.tabAuto()
            ...
            tabAuto: function(l) {
                ...
                u(".layui-tab").each(function() {
                    ...
                    e && "false" !== e && a.find("li").each(function() {
                        var t, i = u(this);
                        i.find("." + o)[0] || "false" === i.attr("lay-allowclose") || ((t = u('<i class="layui-icon layui-icon-close layui-unselect ' + o + '"></i>')).on("click", C.tabDelete), i.append(t))
                ...
                var a = 0,
                    ...
                    i = function(i) {
                        ...
                        var e = {
                            ...
                            error: function(e) {
                                f.unified ? o += u.fileLength : o++, u.msg(s.error || ["Upload failed, please try again.", "status: " + (e.status || "") + " - " + (e.statusText || "error")].join("<br>")), g(i.index, e.responseText), l(i.index), t(i.file)
                            }
                        };
                ...
                n = {
                    input: function(e) {
                        var e = e || a.find("input,textarea"),
                            t = (i.autocomplete && e.attr("autocomplete", i.autocomplete), function(e, t) {
                                ...
                                }).increment[r <= a && !o ? "addClass" : "removeClass"](E), n.decrement[a <= l && !o ? "addClass" : "removeClass"](E))
                            });
                            ...
                            var r = T(this),
                                ...
                                n = function(i) {
                                    ...
                                    l[0] ? ((n = l.find("." + u))[0] && n.remove(), l.prepend(t), r.css("padding-right", function() {
                                        ...
                                        T(this).hasClass(E) || ("function" == typeof i.click && i.click.call(this, r, i), layui.event.call(this, $, "input-affix(" + e + ")", {
                                            elem: r[0],
                                            affix: s,
                                            options: i
                                        }))
                    ...
                    select: function(e) {
                        var p = "\u8bf7\u9009\u62e9",
                            ...
                            e = e || a.find("select"),
                            y = function(n, e, t, i, d, a) {
                                var l, h, r, s, o, c, u, p, f, y = T(this),
                                    v = e,
                                    m = v.find("input"),
                                    g = n.find("dl"),
                                    ...
                                    x = "";
                                t || (h = y.attr("lay-search"), r = y.attr("lay-append-to") || "body", s = y.attr("lay-append-position"), o = !(!lay.ie || "10" !== lay.ie && "11" !== lay.ie || !m.attr("placeholder")), c = function() {
                                    a && (n.appendTo(r).css({
                                        width: v.width() + "px"
                                    }), (e = function() {
                                    ...
                                    var e = n.offset().top + n.outerHeight() + 5 - F.scrollTop(),
                                        t = g.outerHeight(),
                                        i = g.children("dd");
                                    k = y[0].selectedIndex, v.parent().addClass(C + "ed"), i.removeClass(j), b.removeClass(j), i.removeClass(A), 0 <= k && i.eq(k).addClass(A), e + t > F.height() && t <= e && n.addClass(C + "up"), p(), o && g.off("mousedown.lay_select_ieph").on("mousedown.lay_select_ieph", function() {
                                    ...
                                    v.parent().removeClass(C + "ed " + C + "up"), m.blur(), d && g.children("." + _).remove(), l && l(), a && (n.detach(), T(window).off("resize.lay_select_resize")), e || f(m.val(), function(e) {
                                    ...
                                    var e = n.keyCode,
                                        t = (9 === e && u(), function(e) {
                                            n.preventDefault();
                                            var t, i, a = g.children("dd:not(." + j + ",." + E + ")");
                                    ...
                                    var r = 0,
                                        ...
                                        t = (layui.each(t, function() {
                                            var e = T(this),
                                                t = e.text(),
                                                i = d && e.hasClass(_),
                                                a = (d && !i && t === o && (s = !0), c && (t = t.toLowerCase()), !u.test(t));
                                            ("" === n || "blur" === l ? n !== t : a) && r++, "keyup" === l && e[(d ? a && !i : a) ? "addClass" : "removeClass"](j)
                                    ...
                                    return 9 !== t && 13 !== t && 37 !== t && 38 !== t && 39 !== t && 40 !== t && (o && e.target.__ieph ? e.target.__ieph = !1 : (f(n, function(e, t) {
                                        var i, a;
                                        d ? t ? g.children("." + _).remove() : (t = g.children("." + _))[0] ? t.attr("lay-value", n).html(N.escape(n)) : (t = T("<dd>").addClass(_).attr("lay-value", n).html(N.escape(n)), a = (i = g.children().eq(0)).hasClass("layui-select-tips"), i[a ? "after" : "before"](t)) : e ? g.find("." + w)[0] || g.append('<p class="' + w + '">\u65e0\u5339\u914d\u9879</p>') : g.find("." + w).remove()
                                    }, "keyup"), "" === n && (y.val(""), g.find("." + A).removeClass(A), (y[0].options[0] || {}).value || g.children("dd:eq(0)").addClass(A), g.find("." + w).remove(), d) && g.children("." + _).remove(), void p()))
                                    ...
                                    var e, t = T(this),
                                        i = t.attr("lay-value"),
                                        a = y.attr("lay-filter");
                                    return t.hasClass(E) || (t.hasClass("layui-select-tips") ? m.val("") : (m.val(t.text()), t.addClass(A)), d && t.hasClass(_) && (g.append(t.removeClass(_)), e = T("<option>").attr("value", i).text(t.text()), y.append(e)), t.siblings().removeClass(A), y.val(i).removeClass("layui-form-danger"), layui.event.call(this, $, "select(" + a + ")", {
                                        elem: y[0],
                                        value: i,
                                        othis: n
                                    }), u(!0)), !1
                        ...
                        T.event.special["_lay-select-destroy"] = {
                            ...
                            var s, o, c = "string" == typeof i.attr("lay-search"),
                                ...
                                t = T(['<div class="layui-select-title">', '<input type="text" placeholder="' + N.escape(T.trim(t)) + '" value="' + N.escape(T.trim(l ? r.html() : "")) + '"' + (!n && c ? "" : " readonly") + ' class="layui-input' + (c ? "" : " layui-unselect") + (n ? " " + E : "") + '">', '<i class="layui-edge"></i>', "</div>"].join("")),
                                r = T(['<dl class="layui-anim layui-anim-upbit' + (i.find("optgroup")[0] ? " layui-select-group" : "") + '">', (r = i.find("*"), s = [], layui.each(r, function(e, t) {
                                    var i = t.tagName.toLowerCase();
                                    0 !== e || t.value || "optgroup" === i ? s.push("optgroup" === i ? "<dt>" + t.label + "</dt>" : '<dd lay-value="' + N.escape(t.value) + '" class="' + (l === t.value ? A : "") + (t.disabled ? " " + E : "") + '">' + T.trim(t.innerHTML) + "</dd>") : s.push('<dd lay-value="" class="layui-select-tips">' + T.trim(t.innerHTML || p) + "</dd>")
                                }), 0 === s.length && s.push('<dd lay-value="" class="' + E + '">\u6ca1\u6709\u9009\u9879</dd>'), s.join("") + "</dl>")].join(""));
                    ...
                    checkbox: function(e) {
                        ...
                        e.each(function(e, t) {
                            ...
                            l = T(['<div class="layui-unselect ' + r[0], t.checked ? " " + r[1] : "", l ? " layui-checkbox-disabled " + E : "", '"', a ? ' lay-skin="' + a + '"' : "", ">", (s = {
                    ...
                    radio: function(e) {
                        ...
                        e.each(function(e, t) {
                            ...
                            var a = N.escape(t.title || ""),
                                ...
                                }), r = r.join(" "), T(['<div class="layui-unselect ' + o, t.checked ? " " + o + "ed" : "", (n ? " layui-radio-disabled " + E : "") + '"', l ? ' lay-skin="' + l + '"' : "", ">", '<i class="layui-anim layui-icon ' + c[t.checked ? 0 : 1] + '"></i>', "<div " + r + ">" + a + "</div>", "</div>"].join("")));
                            i.after(s),
                                function(i) {
                                    var a = T(this),
...
layui.define(["lay", "laytpl", "laypage", "form", "util"], function(s) {
    ...
    var p = layui.$,
        ...
        c = (n.prototype.config = {
            ...
            a.index = t.index, t.key = a.id || a.index, t.setInit(), a.height && /^full-.+$/.test(a.height) ? (t.fullHeightGap = a.height.split("-")[1], a.height = r.height() - (parseFloat(t.fullHeightGap) || 0)) : a.height && /^#\w+\S*-.+$/.test(a.height) ? (i = a.height.split("-"), t.parentHeightGap = i.pop(), t.parentDiv = i.join("-"), a.height = p(t.parentDiv).height() - (parseFloat(t.parentHeightGap) || 0)) : "function" == typeof a.height && (t.customHeightFunc = a.height, a.height = t.customHeightFunc());
            var l, e = a.elem,
                i = e.next("." + D),
                n = t.elem = p("<div></div>");
            n.addClass((l = [D, D + "-" + t.index, "layui-form", "layui-border-box"], a.className && l.push(a.className), l.join(" "))).attr(((l = {
                ...
                data: a,
                index: t.index
            })), t.renderStyle(), i[0] && (t.resizeObserver && t.resizeObserver.unobserve(t.elem[0]), i.remove()), e.after(n), t.layTool = n.find(".layui-table-tool"), t.layBox = n.find(".layui-table-box"), t.layHeader = n.find(o), t.layMain = n.find(".layui-table-main"), t.layBody = n.find(A), t.layFixed = n.find(".layui-table-fixed"), t.layFixLeft = n.find(".layui-table-fixed-l"), t.layFixRight = n.find(O), t.layTotal = n.find(".layui-table-total"), t.layPage = n.find(".layui-table-page"), t.renderToolbar(), t.renderPagebar(), t.fullSize(), t.pullData(t.page), t.events()
            ...
            d.height = d.maxHeight || d.height, d.css && -1 === d.css.indexOf(D) && (a = d.css.split("}"), layui.each(a, function(e, t) {
                t && (a[e] = "." + D + "-" + r.index + " " + t)
            }), d.css = a.join("}"));
                                ...
                                list: (a = [], o.eachCols(function(e, t) {
                                    ...
                                    i.on("checkbox(LAY_TABLE_TOOL_COLS)", function(e) {
                                        var e = p(e.elem),
                                            ...
                                            l = i.hide,
                                            e = e.data("parentkey");
                                        i.key && (i.hide = !t, o.elem.find('*[data-key="' + a + '"]')[t ? "removeClass" : "addClass"](R), l != i.hide && o.setParentCol(!t, e), o.resize(), layui.event.call(this, T, "colToggled(" + r + ")", {
                                            col: i,
                                            config: n
                                        }))
                                    })
                    ...
                    exports: {
                        ...
                        onClick: function(e) {
                            var t = e.data,
                                ...
                                i = e.openPanel,
                                e = e.elem;
                            if (!t.length) return f.tips("\u5f53\u524d\u8868\u683c\u65e0\u6570\u636e", e, {
                                tips: 3
                            });
            ...
            a[0] && (t.layNone.remove(), a.remove()), t.layFixed.addClass(R), t.layMain.find("tbody").html(""), t.layMain.append(t.layNone = e), t.layTotal.addClass(y), t.layPage.find(P).addClass(y), x.cache[t.key] = [], t.syncCheckAll(), t.renderForm(), t.setColsWidth(), t.loading(!1)
            ...
            t = t || {}, "function" == typeof n.before && n.before(n), l.startTime = (new Date).getTime(), t.renderData ? ((e = {})[r.dataName] = x.cache[l.key], e[r.countName] = n.url ? "object" === layui.type(n.page) ? n.page.count : e[r.dataName].length : n.data.length, "object" == typeof n.totalRow && (e[r.totalRowName] = p.extend({}, l.totalRow)), l.renderData({
                res: e,
                curr: a,
                count: e[r.countName],
                type: t.type,
            ...
            })) : "array" === layui.type(n.data) && (e = {}, i = a * n.limit - n.limit, o = n.data.concat(), e[r.dataName] = n.page ? o.splice(i, n.limit) : o, e[r.countName] = n.data.length, "object" == typeof n.totalRow && (e[r.totalRowName] = p.extend({}, n.totalRow)), l.totalRow = e[r.totalRowName], l.renderData({
                res: e,
                curr: a,
                count: e[r.countName],
                type: t.type
            ...
            return n = n || 1, layui.each(a, function(e, o) {
                ...
                }), e = ['data-index="' + e + '"'], o[x.config.checkName] && e.push('class="' + _ + '"'), e = e.join(" "), y.push("<tr " + e + ">" + i.join("") + "</tr>"), h.push("<tr " + e + ">" + r.join("") + "</tr>"), f.push("<tr " + e + ">" + d.join("") + "</tr>"))
            }), {
                trs: y,
                trs_fixed: h,
                trs_fixed_r: f
            ...
            return x.cache[a.key] = r, a.layTotal[0 == r.length ? "addClass" : "removeClass"](y), a.layPage[i.page || i.pagebar ? "removeClass" : "addClass"](R), a.layPage.find(P)[!i.page || 0 == n || 0 === r.length && 1 == l ? "addClass" : "removeClass"](y), 0 === r.length ? a.errorView(i.text.none) : (a.layFixLeft.removeClass(R), o ? u() : (u(), a.renderTotal(r, t), a.layTotal && a.layTotal.removeClass(R), void(i.page && (i.page = p.extend({
            ...
            c.totalRow && (layui.each(e, function(e, i) {
                ...
                var a, e = t.field || e,
                    ...
                    l = (a = t.totalRowText || "", (n = {
                        LAY_COL: t
                    })[e] = l, n = t.totalRow && C.call(d, {
                        item3: t,
                        content: l,
                        tplData: n
                    }) || a, i || n),
                    n = (t.field && d.dataTotal.push({
                        field: t.field,
            ...
            var a, e = this,
                ...
                t = n || o,
                r = (t && e.layBox.addClass(I), o && (a = {}, layui.each(i.index, function(e, t) {
                    a[t] = !0
                }), i.index = a), n || o ? "tr" : 'tr[data-index="' + i.index + '"]'),
                d = (r = e.layBody.find(r), n ? r : r.filter(o ? function() {
                ...
                s = "checked" in i,
                u = function(e) {
                    return "radio" === i.type || (s ? i.checked : !e)
                },
                y = {},
                r = (layui.each(c, function(e, t) {
                    var a;
                    "array" === layui.type(t) || t[l.disabledName] ? y[e] = !0 : n || (o ? i.index[e] : Number(i.index) === e) ? (a = t[l.checkName] = u(t[l.checkName]), n || o || ((e = d.filter('[data-index="' + e + '"]'))[a ? "addClass" : "removeClass"](_), "radio" === i.type && e.siblings().removeClass(_))) : "radio" === i.type && delete t[l.checkName]
                }), n ? d.each(function(e) {
                ...
                h = r.last(),
                f = h.closest(O);
            ("radio" === i.type && f.hasClass(R) ? r.first() : r).prop("checked", u(h.prop("checked"))), e.syncCheckAll(), t && setTimeout(function() {
            ...
            t.sortKey = {
                field: r,
                sort: l.type
            }, i.autoSort && ("asc" === l.type ? e = layui.sort(o, r, null, !0) : "desc" === l.type ? e = layui.sort(o, r, !0, !0) : (e = layui.sort(o, x.config.indexName, null, !0), delete t.sortKey, delete i.initSort)), a[i.response.dataName] = e || o, t.renderData({
                res: a,
                curr: t.page,
                count: t.count,
                sort: !0,
            ...
            var e, a, i = this,
                t = i.config,
                l = t.height;
            i.fullHeightGap ? (l = r.height() - i.fullHeightGap) < 135 && (l = 135) : i.parentDiv && i.parentHeightGap ? (l = p(i.parentDiv).height() - i.parentHeightGap) < 135 && (l = 135) : i.customHeightFunc && (l = i.customHeightFunc()) < 135 && (l = 135), 1 < t.cols.length && (e = i.layFixed.find(o).find("th"), a = i.layHeader.first(), layui.each(e, function(e, t) {
            ...
            e.layFixed.find(A).css("height", t.height() >= n ? n : "auto").scrollTop(e.layMain.scrollTop()), e.layFixRight[x.cache[e.key] && x.cache[e.key].length && 0 < l ? "removeClass" : "addClass"](R), e.layFixRight.css("right", a - 1)
            ...
            layui.each(e, function(e, t) {
                ...
                a = t.index, l = t.data, n = t.related, o = s[a] || {}, r = d.layBody.find('tr[data-index="' + a + '"]'), layui.each(l, function(e, t) {
                    ...
                    (i in l || ("function" == typeof n ? n(i, e) : n) && (t.templet || t.toolbar)) && (i = (e = r.children('td[data-field="' + i + '"]')).children(c), a = o[t.field], i.html(C.call(d, {
                        item3: t,
                        content: a,
                        tplData: p.extend({
                            LAY_COL: t
            ...
            var c = this,
                ...
                y = (c.layTool.on("click", "*[lay-event]", function(e) {
                    ...
                    var t, a, i, l, n;
                    k.eventMoveElem && (i = (t = k.eventMoveElem).closest("." + D).attr(N), a = w(i)) && (i = t.data("key"), l = a.col(i), n = a.config.elem.attr("lay-filter"), d = {}, r.css("cursor", ""), a.scrollPatch(), t.removeData(S), delete k.eventMoveElem, a.cssRules(i, function(e) {
                ...
                l = function(e, t) {
                    var a = p(this),
                        ...
                        d = p('<i class="layui-icon layui-icon-up ' + i + '">');
                    "tips" === (t = t || n.expandedMode || s.cellExpandedMode) ? c.tipsIndex = f.tips(['<div class="layui-table-tips-main" style="margin-top: -' + (r.height() + 23) + "px;" + ("sm" === s.size ? "padding: 4px 15px; font-size: 12px;" : "lg" === s.size ? "padding: 14px 15px;" : "") + '">', r.html(), "</div>", '<i class="layui-icon layui-table-tips-c layui-icon-close"></i>'].join(""), r[0], {
                        tips: [3, ""],
                        time: -1,
                        anim: -1,
                    ...
                    }), c.setRowActive(o, j), r.next("." + i)[0] || r.after(d), d.on("click", function() {
                        var t = p(this);
    ...
    x.eachCols = function(e, a, i) {
        ...
        var d, c, s, u, y = l.tree && l.tree.view;
        if (y) try {
        ...
        r.href = "data:" + n + ";charset=utf-8,\ufeff" + encodeURIComponent((d = [], c = [], s = [], u = {}, layui.each(t, function(i, l) {
            var n = [];
            "object" == typeof e ? (layui.each(e, function(e, t) {
                ...
                var a;
                !1 === t.ignoreExport || t.field && "normal" == t.type ? t.hide && !1 !== t.ignoreExport || !0 === t.ignoreExport ? 0 == i && (u[t.field] = !0) : ((a = l[t.field]) !== undefined && null !== a || (a = ""), 0 == i && d.push(t.fieldTitle || t.title || t.field || ""), a = (a = C.call(o, {
                    item3: t,
                    content: a,
                    tplData: l,
                    text: "text",
        ...
        }), d.join(",") + "\r\n" + c.join("\r\n") + "\r\n" + s.join(","))), r.download = (a.title || l.title || "table_" + (l.index || "")) + "." + i, document.body.appendChild(r), r.click(), document.body.removeChild(r)
...
layui.define(["table"], function(e) {
    ...
    var A = layui.$,
        ...
        g = function(n, i, e) {
            var l = P.cache[n];
            layui.each(e || l, function(e, t) {
                var a = t[z] || ""; - 1 !== a.indexOf("-") && (l[a] = t), t[i] && g(n, i, t[i])
            })
        },
        d = function(d, a, e) {
            var r = j(d),
            ...
            "reloadData" === e && "fixed" === o.scrollPos && (r.scrollTopCache = r.config.elem.next().find(s).scrollTop()), o.url ? e && (!l || l.mod) || (a.parseData = function() {
                ...
                var e, t = arguments,
                    ...
                    l = (r.updateStatus(null, {
                        LAY_HAS_EXPANDED: !1
                    }), g(d, c), i.find('[name="layTableCheckbox"][lay-filter="layTableAllChoose"]'));
    ...
    var r, U = function(e, t, a) {
        ...
        u = (B.updateNode = function(e, a, t) {
            ...
            var t = e.config,
                a = t.elem.next();
            t.id;
            a.hasClass(h) && (o(e), (t.tree || {}).view.dblClickExpand) && J({
                trElem: e.tr.first()
            }, null, null, null, !0)
...
layui.define(["jquery", "lay"], function(e) {
    ...
    i.prototype.config = {
        ...
        var i = this,
            e = i.config,
            n = a(['<button type="button" class="layui-icon ' + ("updown" === e.anim ? "layui-icon-up" : "layui-icon-left") + " " + o + '" lay-type="sub"></button>', '<button type="button" class="layui-icon ' + ("updown" === e.anim ? "layui-icon-down" : "layui-icon-right") + " " + o + '" lay-type="add"></button>'].join(""));
...
layui.define("jquery", function(o) {
    ...
    l.prototype.load = function(o) {
        var i, n, r, l, c, m, e, t, a, f, s, u, p, d, y, h = this,
            g = 0,
            v = w((o = o || {}).elem);
