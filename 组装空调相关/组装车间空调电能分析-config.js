...
window.PAGE_CONFIG = {
    ...
    fetchData: async function(params) {
        ...
        try {
            ...
            console.error('获取组装车间空调电能数据失败:', error);
            //return getMockData(timeType, startDate, endDate);
        }
    }
};
...
console.log('%c 📊 组装车间空调电能分析 - 双Y轴图表 + 横向表格', 'color: #1e88e5; font-weight: bold; font-size: 16px;');
console.log('%c━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━', 'color: #666;');
console.log(`
%c图表布局说明：
