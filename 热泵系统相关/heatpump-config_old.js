...
elec_raw_calc AS (
    ...
    FROM (
        ...
        FROM data_all 
        WHERE 
            (no IN (320022, 320024) OR (no BETWEEN 420001 AND 420015))
            AND KWH > 0
...
elec_final_view AS (
    SELECT 
        ...
        CASE 
            ...
            WHEN cfg.NO IN (420009) THEN '4-雅士组'
    ...
    JOIN elec_raw_calc rd ON cfg.NO = rd.no OR (cfg.NO = 420009 AND rd.no = 320024) OR (cfg.NO = 420010 AND rd.no = 320022)
